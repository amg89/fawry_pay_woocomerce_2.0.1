...
function my_faw_get_unpaid_submitted() {        
        global $wpdb;
...
function my_faw_wc_cancel_unpaid_submitted() {        
        $unpaid_submit = my_faw_get_unpaid_submitted();
...
add_action( 'woocommerce_cancel_unpaid_submitted', 'my_faw_wc_cancel_unpaid_submitted' );//for customization purposes
